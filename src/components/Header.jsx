    ...
    <>
        <header className='bg-[#F7F7F7] '>
            ...
            <div className="max-w-[1140px] bg-[#F7F7F7] h-[38px] mt-5 mx-auto flex justify-between items-center">
              ...
              <Link to={"tel:+992105555511"}><span className=' text-lg'>Номер:</span><span> 10-55555-11</span></Link>
            ...
            <div className="max-w-[1140px] p-4  h-[60px]  mx-auto flex justify-between items-center ">
              <Link to={"/catalog"}><H4 className='active:text-red-500 lg:flex sm:hidden'>Все товари</H4></Link>              
              <Link to={"/catalog/true"}><H4 className='active:text-red-500 flex md:hidden'>Товари по акции</H4></Link>              
